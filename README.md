...
- Voltage divider resistors (2.2kΩ, 4.7kΩ)
...
│   ├── sender/                        # ESP32C6 Sender firmware
│   │   ├── sender_arduino.ino         # Main sender code
│   │   ├── config.h                   # Pin definitions & settings
│   │   ├── data_packet.h              # ESP-NOW data structure
│   │   ├── console_menu.cpp/h         # Interactive serial menu
│   │   ├── settings.cpp/h             # Settings persistence
│   │   └── ads1115_config.h           # Pressure sensor config
│   │
│   └── display/                       # CYD Display firmware
│       ├── CYD_Speedo_Modern2.ino     # Main display code
│       └── Get_MAC_Address.ino        # Utility to find MAC
│
├── hardware/                          # Hardware documentation
│   ├── sender/                        # Sender wiring & schematics
│   │   ├── wiring.md                  # Connection guide
│   │   └── parts-list.md              # Component list
│   ├── display/                       # Display information
│   │   └── cyd-info.md                # CYD specifications
│   └── bill-of-materials.md           # Complete BOM
│
├── laptop/                            # Laptop GPS setup
│   ├── README.md                      # Setup guide
│   └── gps-config.md                  # gpsd configuration
│
├── docs/                              # Documentation
│   ├── setup/                         # Setup guides
│   │   ├── getting-started.md         # Quick start guide
│   │   ├── sender-setup.md            # Sender configuration
│   │   ├── display-setup.md           # Display configuration
│   │   └── espnow-setup.md            # ESP-NOW configuration
│   ├── communication-protocol.md      # ESP-NOW protocol v3
│   ├── gps-serial-protocol.md         # GPS data format
...
- **Oil Temperature Range:** -200°C to +1350°C (K-type thermocouple)
...
- **Temperature Accuracy:** ±0.7°C (MAX31856)
...
typedef struct __attribute__((packed)) {
  ...
  float oilTemperature;      // OIL temp (°C)
...
- Verify sender shows "✓ Delivery Success" in serial output
...
Ready to monitor your vehicle! 🚗📊
#   e s p 3 2 - v e h i c l e - m o n i t o r  
 